  ...
  return (
    <div>
        ...
        <div className="relative mb-2 inline-block">
          ...
          {file && (
            <button
              ...
              className="absolute -top-2 -right-2 p-1 bg-white border border-gray-200 text-gray-500 hover:text-red-500 rounded-full shadow-sm transition-colors"
            >
      ...
      <div
        ...
        className="flex items-center gap-3 px-4 py-3 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer hover:border-teal-400 bg-gray-50/50 hover:bg-teal-50/30 transition-all duration-200"
      >
        <UploadCloud className="w-5 h-5 text-teal-600/60 shrink-0" />
        <div className="min-w-0 flex-1">
          {file ? (
            <p className="text-sm text-gray-700 font-medium truncate">{file.name}</p>
          ) : (
            <p className="text-sm text-gray-500">
              <span className="font-medium text-teal-600">Choose file</span>
    ...
    <div className="space-y-6">
      ...
      {!isExistingProfile && authUser && (
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          ...
          <p className="text-xs text-gray-400 mt-3">These details come from your account and cannot be edited here.</p>
        </div>
      )}
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div>
                ...
                <input
                  ...
                  className="block w-full rounded-lg border border-gray-300 px-4 py-2.5 text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-teal-500 sm:text-sm"
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          ...
          <div className="space-y-5">
            <div>
              <label htmlFor="nationalId" className="block text-sm font-medium text-gray-700 mb-1.5">National ID Number</label>
              <input
                id="nationalId"
                required
                type="text"
        ...
        <div className="flex justify-end">
          <button
            type="submit"
            disabled={isPending}
            className="inline-flex justify-center items-center px-8 py-3 border border-transparent text-sm font-semibold rounded-xl shadow-sm text-white bg-teal-600 hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500 disabled:opacity-60 disabled:cursor-not-allowed transition-all min-w-[180px]"
          >
            {isPending ? (
