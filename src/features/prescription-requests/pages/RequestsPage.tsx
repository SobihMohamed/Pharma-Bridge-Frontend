    ...
    <div className="max-w-[1440px] mx-auto py-8 px-4 sm:px-6 lg:px-8 space-y-8 font-sans">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 mb-8">
        ...
        <div className="flex items-center gap-4 px-6 py-3 bg-white border border-gray-200 rounded-2xl shadow-sm">
          ...
          <span className="text-sm font-semibold leading-tight text-gray-500">
            Total<br />Requests
          </span>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            {pageIndex === 1 && status === '' && search === '' && (
              <article 
                ...
                className="bg-gray-50 border-2 border-dashed border-gray-300 rounded-3xl flex flex-col items-center justify-center p-8 group cursor-pointer hover:bg-[#009ADA]/5 hover:border-[#009ADA]/30 transition-all min-h-[300px]"
              >
                <div className="w-16 h-16 rounded-full bg-white border border-gray-200 flex items-center justify-center text-[#009ADA] mb-4 group-hover:scale-110 group-hover:bg-[#009ADA] group-hover:text-white transition-all shadow-sm">
                  <Plus className="w-8 h-8" />
                </div>
                <p className="text-2xl font-semibold text-gray-900 group-hover:text-[#009ADA] transition-colors">New Request</p>
                <p className="text-gray-500 text-center mt-2 px-4 text-base">Submit a new prescription to receive offers.</p>
              </article>
            )}
            ...
            {requests.length === 0 && (pageIndex !== 1 || status !== '' || search !== '') && (
              <div className="col-span-1 md:col-span-2 lg:col-span-3 flex flex-col items-center justify-center py-20 bg-white rounded-3xl border border-dashed border-gray-200">
