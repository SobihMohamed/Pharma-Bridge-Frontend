...
import { Pill, Mail, Lock, Eye, EyeOff, ArrowRight, ShieldCheck, Sparkles, CheckCircle2 } from "lucide-react";
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-gradient-to-br from-[#075985] via-[#0369a1] to-[#0284c7] overflow-hidden items-center justify-center p-16 xl:p-20">
        ...
        <div className="relative z-10 w-full max-w-md flex flex-col justify-between h-full pr-8">
          ...
          >
            ...
            >
              Access the central administration console to verify pharmacy stores, audit transactions, oversee user accounts, and compile system analytics.
            </motion.p>
            ...
            <motion.div variants={itemVariants} className="space-y-3 pt-4 text-xs text-[#bae6fd]/90 border-t border-white/10">
              <div className="flex items-start gap-3">
                ...
                <span>Pharmacy Store Verification & Auditing</span>
              </div>
              <div className="flex items-start gap-3">
                <div className="p-1 bg-white/10 rounded-md">
                  <CheckCircle2 className="w-4 h-4 text-white" />
                </div>
                <span>Platform System Metrics & Health logs</span>
              </div>
            </motion.div>
          </motion.div>
        ...
        >
          ...
          <div className="mt-8 text-center">
            <p className="text-xs text-slate-400 leading-relaxed">
              By accessing the portal, you agree to comply with our{' '}
