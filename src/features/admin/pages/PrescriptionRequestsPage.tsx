        ...
        <div className="bg-white border border-slate-100 rounded-2xl p-5 shadow-sm space-y-5">
          ...
          <div className="border-b border-slate-100 pb-3 flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-2 text-xs font-bold text-slate-500 hover:text-slate-800 border border-slate-200 rounded-xl hover:bg-slate-50 transition-colors shadow-sm self-start md:self-auto"
            >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 pt-1 animate-fadeIn">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    className="w-full h-10 bg-slate-50 border border-slate-250 rounded-xl pl-9 pr-4 text-sm focus:outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-300 outline-none transition-all placeholder:text-slate-400"
              ...
              <div className="space-y-1.5">
                ...
                <select
                  className="w-full h-10 bg-slate-50 border border-slate-250 rounded-xl px-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-300 outline-none transition-all cursor-pointer appearance-none"
              ...
              <div className="space-y-1.5">
                ...
                <input
                  className="w-full h-10 bg-slate-50 border border-slate-250 rounded-xl px-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-300 outline-none transition-all placeholder:text-slate-400"
                  type="number"
                  min="0"
                  step="1"
                  placeholder="e.g. 10"
              ...
              <div className="space-y-1.5">
                ...
                <input
                  className="w-full h-10 bg-slate-50 border border-slate-250 rounded-xl px-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-300 outline-none transition-all"
                  type="date"
                  min="2026-01-01"
              ...
              <div className="flex items-end gap-3 pb-0.5">
                <button
                  ...
                  className="flex-1 h-10 bg-slate-900 hover:bg-slate-800 text-white font-bold text-xs rounded-xl flex items-center justify-center gap-1.5 transition-colors shadow-sm"
                >
                ...
                {hasActiveFilters && (
                  <button
                    ...
                    className="flex-1 h-10 bg-slate-100 hover:bg-slate-200 text-slate-700 font-bold text-xs rounded-xl flex items-center justify-center gap-1.5 transition-colors border border-slate-200"
                  >
                    Clear All
                  </button>
                )}
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-6 py-4 max-w-[200px]">
                          <span
                            className="font-bold text-slate-800 text-[14px] block truncate"
                        ...
                        <td className="px-6 py-4 text-right">
                          <button
                            ...
                            className="px-3.5 py-1.5 text-xs font-bold text-slate-600 hover:text-slate-800 border border-slate-200 rounded-xl hover:bg-slate-50 hover:border-slate-300 transition-colors shadow-sm"
                          >
                            Inspect
                          </button>
                        </td>
